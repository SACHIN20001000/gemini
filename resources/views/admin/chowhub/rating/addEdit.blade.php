...
<div class="container">
    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <a class="btn btn-main-primary ml_auto" href="{{ route('chowhub-ratings.index') }}">View Rating</a>
    </div>
    <!-- breadcrumb -->
    <!--Row-->
    <!-- row -->
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <!--  start  -->
                    <form  id="rating-add-edit" action="{{isset($rating) ? route('chowhub-ratings.update',$rating->id) : route('chowhub-ratings.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
