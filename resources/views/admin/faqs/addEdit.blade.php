...
<div class="container">
    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <a class="btn btn-main-primary ml_auto" href="{{ route('questions.index') }}">View Questions</a>
    </div>
    <!-- breadcrumb -->
    <!--Row-->
    <!-- row -->
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <!--  start  -->
                    <form  id="faq-add-edit" action="{{isset($faq) ? route('questions.update',$faq->id) : route('questions.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
