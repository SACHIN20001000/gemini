...
<div class="container">
    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <a class="btn btn-main-primary ml_auto" href="{{ route('solutionhub-categories.index') }}">View Categories</a>
    </div>
    <!-- breadcrumb -->
    <!--Row-->
    <!-- row -->
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <!--  start  -->
                    <form  id="category-add-edit" action="{{isset($category) ? route('solutionhub-categories.update',$category->id) : route('solutionhub-categories.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    ...
                                    <input  name="type" type="hidden" value="Solutionhub">
...
@if(isset($category))
{!! JsValidator::formRequest('App\Http\Requests\Admin\Solutionhub\Category\UpdateCategory','#category-add-edit') !!}
@else
{!! JsValidator::formRequest('App\Http\Requests\Admin\Solutionhub\Category\AddCategory','#category-add-edit') !!}
@endif
