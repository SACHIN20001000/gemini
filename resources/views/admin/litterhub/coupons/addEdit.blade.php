...
<div class="container">
    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <a class="btn btn-main-primary ml_auto" href="{{ route('litterhub-coupons.index') }}">View Coupons</a>
    </div>
    <!-- breadcrumb -->
    <!--Row-->
    <!-- row -->
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <!--  start  -->
                    <form  id="coupon-add-edit" action="{{isset($coupon) ? route('litterhub-coupons.update',$coupon->id) : route('litterhub-coupons.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
