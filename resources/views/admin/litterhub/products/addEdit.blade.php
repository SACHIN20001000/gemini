...
<div class="container">
    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        @if(isset($product))
        <a class="btn btn-main-primary ml_auto" style=" margin-left: 730px;"  href="{{route('litterhub_duplicate','id='.$product->id)}}">Duplicate Product</a>
        @endif
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row row-xs align-items-center mg-b-20" >
                                        <div class="col-md-4">
                                            <label class="form-label mg-b-0">Scented</label>
                                        </div>
                                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    ...
                                    <div class="row row-xs align-items-center mg-b-20">
                                        <div class="col-md-4">
                                            <label class="form-label mg-b-0">Clumping</label>
                                        </div>
                                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                                    ...
                                    <div class="row row-xs align-items-center mg-b-20">
                                        <div class="col-md-4">
                                            <label class="form-label mg-b-0">Litter Material</label>
                                        </div>
                                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                                        <select name="litter_material[]" class="form-control select2"id="select" multiple="multiple" >
                                              ...
                                              <option value="corn"<?php  if(isset($product->litter_material)){  if(in_array('corn', json_decode($product->litter_material))){echo "Selected";}}?>>Corn</option>
                                              <option value="walnut"<?php  if(isset($product->litter_material)){ if(in_array('walnut', json_decode($product->litter_material))){echo "Selected";}}?>>Walnut</option>
                                              <option value="wheat"<?php  if(isset($product->litter_material)){ if(in_array('wheat', json_decode($product->litter_material))){echo "Selected";}}?>>Wheat</option>
                                              <option value="paper"<?php  if(isset($product->litter_material)){ if(in_array('paper', json_decode($product->litter_material))){echo "Selected";}}?>>Paper</option>
...
// trext editor section
                                            ...
                                            $.ajax({
                                            type:'POST',
                                                    url:'/admin/delete-litterhub-photo',
                                                    data: data,
                                            ...
                                            $.ajax({
                                            type:'POST',
                                                    url:'/admin/delete-litterhub-description-photo',
                                                    data: data,
                                                    success:function(data){
                                            ...
                                            $.ajax({
                                            type:'POST',
                                                    url:'/admin/delete-litterhub-feature-page-photo',
                                                    data: data,
                                                    success:function(data){
                                            ...
                                            $.ajax({
                                            type:'POST',
                                                    url:'/admin/delete-litterhub-variation-img',
                                                    data: data,
                                                    success:function(data){
                                            ...
                                            url:'/admin/save-litterhub-photo',
                                                    fileupload : {
                                            ...
                                            url:'/admin/save-litterhub-description-photo',
                                                    fileupload : {
                                                    maxChunkSize : 1000000
                                                    },
                                                    uploadcompleted : function(e, data) {
