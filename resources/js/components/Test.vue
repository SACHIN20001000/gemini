<template>
  <div>
    ...
    <button class="btn btn-success" @click="submit">Complete</button>
    <button class="btn btn-success" @click="posts">post</button>
    <!-- <textarea v-model="multilinedata" id="" cols="30" rows="10"></textarea>
        <p style="white-space:pre-line" >Textarea  entered is : {{multilinedata}}</p> -->
  </div>
</template>
